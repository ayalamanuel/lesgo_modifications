...
type turbine_t
    ...
    ! angular velocity of the turbine due to angle and fitlered
    real(rprec) :: thetadotx, thetadoty, thetadotz, thetadoty_T
...
type(spacetime_t), allocatable, dimension(:) :: spacetime
contains
