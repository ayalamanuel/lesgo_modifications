...
do
    ...
    if (block_exit_pos == 0) then
        ...
        select case (uppercase(buff(1:equal_pos-1)))
            ...
            case ('THETA_SPREAD')
                Read (buff(equal_pos+1:), *) theta_spread
            case ('AMP')
...
do
    ...
    if (block_exit_pos == 0) then
        ...
        select case (uppercase(buff(1:equal_pos-1)))
            ...
            case ('MOMBAL_DEBUG')
                Read (buff(equal_pos+1:), *) mombal_debug               
            case ('OPT1')
                Read (buff(equal_pos+1:), *) opt1 
            case ('NENERGY')
...
do
    ...
    if (block_exit_pos == 0) then
        ...
        select case (uppercase(buff(1:equal_pos-1)))
            ...
            case ('FLOATING')
                Read (buff(equal_pos+1:), *) floating
            case ('OMEGA_FILTER')
                Read (buff(equal_pos+1:), *) omega_filter
            case ('T_FILTER')
                Read (buff(equal_pos+1:), *) T_filter
            case ('THETA2_FREQ')
