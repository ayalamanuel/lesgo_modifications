...
public :: kx, ky, k2
public :: forw, back, forw_big, back_big, back_wave, forw_wave

real(rprec), allocatable, dimension(:,:) :: kx, ky, k2
integer*8 :: forw, back, forw_big, back_big, back_wave,forw_wave
...
real(rprec), dimension (:,:), allocatable :: data_wave_in1
complex(rprec), dimension (:, :), allocatable :: data_wave_out1
contains
...
allocate( data_wave_in1(nx, ny) )
allocate( data_wave_out1(nx, ny) )
...
! These plans are created for the wave spectrum creation
call dfftw_plan_dft_r2c_2d(forw_wave, nx, ny, data_wave_in1,                      &
    data_wave_out1, FFTW_PATIENT, FFTW_UNALIGNED)
...
deallocate(data_wave_in1)
deallocate(data_wave_out1)
