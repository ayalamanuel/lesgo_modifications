...
public interp_to_uv_grid, trilinear_interp, trilinear_interp_w, binary_search,  &
    ...
    get_wpm_wall_bot, count_lines, get_uLES
...
!*******************************************************************************
!
! This function provides plane-averaged value of the velocity at the matching
! location u_delta_m from EQWM
use types, only: rprec
use param, only : nx, ny
use sim_param, only : u_delta_m
...
do jx = 1, nx
do jy = 1, ny
    uLES_sum = uLES_sum + u_delta_m(jx,jy)
enddo
enddo
